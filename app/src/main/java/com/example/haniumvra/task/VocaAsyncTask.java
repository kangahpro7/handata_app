...
public class VocaAsyncTask extends AsyncTask<String, Integer, VocaItemListResult> {
    ...
    public VocaAsyncTask(TaskResultHandler handler){
    ...
    protected VocaItemListResult doInBackground(String... strings) {
        ...
        int vocaid = Integer.valueOf(strings[1]);

        VocaItemListResult result  = null;

        Map<String, Object> params = new HashMap<String, Object>();
        params.put("vocaid", vocaid);
